...
public class GeminiService {
    ...
    String buildPrompt(String question) {
        return """
            ...
            - ESCOPO RESTRITO: responda APENAS perguntas relacionadas a Copa do Mundo 2026, seleções participantes, jogadores, técnicos, resultados, jogos e produtos do catálogo BrasilDrop. Se a pergunta estiver fora desse escopo, recuse com exatamente esta mensagem: "Só posso ajudar com informações sobre a Copa do Mundo 2026, as seleções e os produtos do BrasilDrop. Tem alguma dúvida sobre esses assuntos?"
